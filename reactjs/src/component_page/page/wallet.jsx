...
//     console.log("Check totalBalance từ localStorage: ", total)
//     // Lưu totalBalance vào localStorage mỗi khi nó thay đổi
//     if (showtotal == 0) {
//       setShowToTal(total)
//     }
//   }, [showtotal]);
...
//                 >{i18n.t('wallet.transaction')}</Button>
...
import { checkPreviousWinner } from '../../util/api';
...
const WalletInterface = () => {
  ...
  // Effect to handle sessionStorage and set total balance
  useEffect(() => {
  ...
  // useEffect(() => {
  //   if (currentUserId) {
  //     const checkWinerPrevious = dispatch(checkPreviousWinner(currentUserId));
  //     console.log("Check notice winner previous: ", checkWinerPrevious);
  //   } else {
  //     notification.info("Vui lòng kết nối ví!!!")
  //   }
  ...
  const handleClickCongBo = () => {
    ...
    setTimeout(() => {
      setIsShowNoticePublish(false); // Reset thông báo khi hết ngày
